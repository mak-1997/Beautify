    ...
    <div id="top_footer">
        <div>
            ...
            <div id="top5"> 
                ...
                <img src="https://www.logo.wine/a/logo/App_Store_(iOS)/App_Store_(iOS)-Badge-Logo.wine.svg" alt="">
            </div>
            <div id="top6">
                <p>(Monday to Saturdday, 8AM to 10PM and Sunday, 10AM to 7PM)</p>
            </div>
        </div>
    </div>
    <div id="mid_footer">
